...
export const TEST_CONFIG = {
  ...
  DURATION_MINUTES: 30,
  /** Сколько всего попыток доступно кандидату (идентификация по анонимному коду) */
  MAX_ATTEMPTS: 2,
} as const
...
export const accountantQuestions: Question[] = [
  ...
  },
  {
    ...
    sampleAnswer: '50 «Касса» — наличные; 51 «Расчётные счета» — безналичные рубли; 52 «Валютные счета» — средства в иностранной валюте; 55 «Специ��льные счета в банках» — аккредитивы, депозиты, чековые книжки; 57 «Переводы в пути» — деньги, сданные в банк, но не зачисленные.',
  ...
  },
  {
    ...
    type: 'open',
    keywords: ['средний', 'дневной', 'заработ��к', 'сумма', 'выплат', 'расчетный', 'период', 'месяцев'],
