...
export const TEST_CONFIG = {
  ...
  DURATION_MINUTES: 30,
  /** Сколько всего попыток доступно кандидату (идентификация по email) */
  MAX_ATTEMPTS: 2,
} as const
...
export const marketingQuestions: Question[] = [
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation: 'Средний цикл сделки в недвиж��мости составляет 3-6 месяцев от первого контакта до покупки.',
    complexity: 'easy',
...
export const accountantQuestions: Question[] = [
  ...
  },
  {
    ...
    sampleAnswer: '50 «Касса» — наличные; 51 «Расчётные счета» — безналичные рубли; 52 «Валютные счета» — средства в иностранной валюте; 55 «Специальные счета в банках» — аккредитивы, депозиты, чековые книжки; 57 «Переводы в пути» — де��ьги, сданные в банк, но не зачисленные.',
  ...
  {
    id: 'acc_kb48',
    text: 'По какой формуле рассчитывается средний дневной заработок для оплаты отпуска при полностью отработанном р��счётном периоде?',
    type: 'open',
    keywords: ['средний', 'дневной', 'заработок', 'сумма', 'выплат', 'расчетный', 'период', 'месяцев'],
    sampleAnswer: 'Средний дневной заработок = сумма выплат за расчётный период (12 месяцев) / 12 / 29,3, где 29,3 — среднемесячное число календарных дней. Сумма отпускных = ��редний дневной заработок × число дней отпуска.',
...
export const accountManagerAIQuestions: AIInterviewQuestion[] = [
  ...
  {
    id: 'am_ai3',
    text: 'Расскажите, как вы готовите��ь к ежеквартальной встрече с крупным клиентом (QBR): какая структура встречи, какие метрики приносите, какие цели ставите?',
    specialization: 'account_manager'
  }
]
