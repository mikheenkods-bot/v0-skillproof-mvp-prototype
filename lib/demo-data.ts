...
export const accountantQuestions: Question[] = [
  ...
  {
    id: 'acc_kb40',
    text: 'Кто является плательщиком НДФЛ, а ��то — налоговым агентом, при выплате зарплаты?',
    type: 'multiple_choice',
    options: [
...
// Случайная выборка вопросов из банка для конкретной поп��тки.
...
export const accountManagerAIQuestions: AIInterviewQuestion[] = [
  ...
  {
    id: 'am_ai3',
    text: 'Расскажит��, как вы готовитесь к ежеквартальной встрече с крупным клиентом (QBR): какая структура встречи, какие метрики приносите, какие цели ставите?',
    specialization: 'account_manager'
  }
]
